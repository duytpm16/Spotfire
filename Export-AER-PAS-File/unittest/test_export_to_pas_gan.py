...
class TestGAN(unittest.TestCase):
    ...
    def test_gas_analysis_data_properties(self):
        ...
        mnemonics = {"LFNUM.": {"optional": False}, "IDENT.": {"optional": False}}
    ...
    def test_dstloc(self):
        ...
        self.pas.pas.data[dependent1] = random.choice(
            [x for x in self.pas.pas.codes[dependent1] if x != "C"]
        )
        ...
        self.pas.pas.data[dependent2] = random.choice(
            [x for x in self.pas.pas.codes[dependent2] if x != 50]
        )
    ...
    def test_depths(self):
        ...
        self.pas.pas.data["TTOPL.M"] = random.uniform(0.001, 7000)
        self.pas.pas.data["TBASL.M"] = random.uniform(
            0.001, self.pas.pas.data["TTOPL.M"]
        )
        self.pas.check_assert_raised()

        # Depths are in valid range and TTOPL < TBASL. Program should not exit with error.
        self.pas.pas.data["TBASL.M"] = random.uniform(0.001, 7000)
        self.pas.pas.data["TTOPL.M"] = random.uniform(
            0.0001, self.pas.pas.data["TBASL.M"]
        )
        self.pas.check_not_assert_raised()

    def test_glr_m3m3(self):
        mnemonic, config = "GLR.M3/M3", {
            "optional": True,
            "allow_zero": False,
            "allow_neg": True,
        }
    ...
    def test_fldh2s(self):
        ...
        self.pas.pas.data[dependent1] = random.choice(
            [x for x in self.pas.pas.codes[dependent1] if x != "L"]
        )
        ...
        self.pas.pas.data[dependent2] = random.choice(
            [x for x in self.pas.pas.codes[dependent2] if x != "N"]
        )
    ...
    def test_h2smt(self):
        ...
        self.pas.pas.data[dependent] = random.choice(
            [x for x in self.pas.pas.codes[dependent] if x != "L"]
        )
        self.pas.char_code_test_sequence(mnemonic, {"optional": False})
    ...
    def test_labh2s(self):
        ...
        # Other dictionary item is based on PAS format file.
        self.pas.pas.data[dependent1] = random.choice(
            [x for x in self.pas.pas.codes[dependent1] if x != "F"]
        )
        config["optional"] = False
        self.pas.numb_test_sequence(mnemonic, config)
    ...
    def test_header_fss_gas_analysis(self):
        ...
        kpa_mnemonics = {
            "FS-RPRES.KPAA": {"optional": False, "allow_zero": False, "allow_neg": True}
        }
        degC_mnemonics = {
            "FS-RTEMP.DEGC": {"optional": False, "allow_zero": True, "allow_neg": True}
        }
        ...
        self.pas.pas.data[dependent] = random.choice(
            [x for x in self.pas.pas.codes[dependent] if x != "C"]
        )
    ...
    def test_header_fss_gas_analysis_spres_stemp(self):
        ...
        kpa_mnemonics = {
            "FS-SPRES.KPAA": {"optional": False, "allow_zero": False, "allow_neg": True}
        }
        degC_mnemonics = {
            "FS-STEMP.DEGC": {"optional": False, "allow_zero": True, "allow_neg": True}
        }
    ...
    def test_header_sss_gas_analysis(self):
        ...
        kpa_mnemonics = {
            "SS-RPRES.KPAA": {"optional": False, "allow_zero": False, "allow_neg": True}
        }
        degC_mnemonics = {
            "SS-RTEMP.DEGC": {"optional": False, "allow_zero": True, "allow_neg": True}
        }
    ...
    def test_header_sss_gas_analysis_spres_stemp(self):
        ...
        kpa_mnemonics = {
            "SS-SPRES.KPAA": {"optional": False, "allow_zero": False, "allow_neg": True}
        }
        degC_mnemonics = {
            "SS-STEMP.DEGC": {"optional": False, "allow_zero": True, "allow_neg": True}
        }
        ...
        # All 'mnemonics' must be null.
        self.pas.pas.data[dependent1] = random.choice(
            [x for x in self.pas.pas.codes[dependent1] if x != "R" and x != "C"]
        )
        self.pas.pas.data[dependent2] = None
        self.pas.pas.data[dependent4] = None
    ...
    def test_header_cl_analysis(self):
        ...
        kpa_mnemonics = {
            "CL-RPRES.KPAA": {"optional": True, "allow_zero": False, "allow_neg": True}
        }
        degC_mnemonics = {
            "CL-RTEMP.DEGC": {"optional": True, "allow_zero": True, "allow_neg": True}
        }
    ...
    def test_header_cl_analysis_spres_stemp(self):
        ...
        kpa_mnemonics = {
            "CL-SPRES.KPAA": {"optional": True, "allow_zero": False, "allow_neg": True}
        }
        degC_mnemonics = {
            "CL-STEMP.DEGC": {"optional": True, "allow_zero": True, "allow_neg": True}
        }
    ...
    def test_cl_data_properties(self):
        ...
        numb_mnemonics = {
            "LH2S.PPM": {"optional": True, "allow_zero": True, "allow_neg": True},
    ...
    def test_rca_data_properties(self):
        ...
        char_code_mnemonics = {
            "SEPCOND.": {"optional": False},
            "LIQGPT.": {"optional": False},
        }
        numb_mnemonics = {
            "LIQRAT.M3/D": {"optional": False, "allow_zero": False, "allow_neg": True},
    ...
    def test_fs_gas_e3m3(self):
        ...
        self.pas.pas.data[dependent1] = random.choice(
            [x for x in self.pas.pas.codes[dependent1] if x != "R"]
        )
        self.pas.pas.data[dependent2] = None
        self.pas.numb_null_only_test_sequence(mnemonic)
    ...
    def test_recombined_gas_composition(self):
        mnemonics = {
            "R-%s.FRAC"
            % (gas): {"optional": True, "allow_zero": False, "allow_neg": True}
    ...
    def test_recombined_gas_properties(self):
        ...
        kpa_mnemonics = {
            "R-PPC.KPAA": {"optional": True, "allow_zero": False, "allow_neg": True}
        }
        degK_mnemonics = {
            "R-PTC.DEGK": {"optional": True, "allow_zero": False, "allow_neg": False}
        }
